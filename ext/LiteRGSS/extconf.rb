...
$INCFLAGS << " -I/usr/include/LiteCGSS/ -I$(srcdir)/../../ -I$(srcdir)/../../external/litecgss/src/src -I$(srcdir)/../../external/SFML/include"
$LDFLAGS << " -L$(srcdir)/../../external/litecgss/bin -L$(srcdir)/../../external/SFML/lib "
